...
async function fixUserStripeData() {
  console.log('🔧 Fixing user Stripe data and sync issues...')
  ...
  try {
    ...
    // Step 2: Update user with proper Stripe data and founding member info
    console.log('👤 Updating user record with proper Stripe data...')
    ...
    console.log('\n🎉 User Stripe data fix completed successfully!')
    console.log('📋 Summary:')
    ...
    console.log('- Subscription Plan: Prospector (Founding Member)')
